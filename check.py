# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 22:25:44 2020
...
def JCItestModel3(Xt, opt_q, alpha):
    ...
    for rn in range(1, NumDim):
        ...
        return [H, JCIstat]
#讀入2015 6月分鐘資料
def check_coint(date,stock1,stock2):
    ...
    if not flag :
        df = pd.DataFrame({"stock1":[stock1],"stock2":[stock2],"w1":[w1],"w2":[w2],"mu":[mu],"std":[std]})
...
if __name__ == "__main__":
    ...
    datelist = [f.split('_')[0] for f in os.listdir(path+path_to_minprice)]
